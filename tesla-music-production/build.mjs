...
await fs.writeFile('public/version.json',JSON.stringify({release:40,source:SOURCE,production:'https://tesla-waze-piped.vercel.app',search:'/api/youtube-search',searchRelease:39,offline:false,airplay:false,icon:'/icons/music-v39-180.png',controls:'mobile-controls-v40.js',nativeQueue:'ios-standalone-auto',oneTapPlay:true}));
console.log('Tesla Music V40: mobile controls, unchanged search, checksum-verified selected PNG icons and online-only worker built.');
