...
for(const name of ['mobile-controls-v40.js','member-v41.js','member-v43-fix.js','member-v44-layout.js']){const r=await fetch(LOCAL+name,{signal:AbortSignal.timeout(20000)});if(!r.ok)throw Error(name+': HTTP '+r.status);await fs.writeFile('public/'+name,Buffer.from(await r.arrayBuffer()));}
...
html=html.replace('</head>',`<meta name="tesla-music-build" content="44"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-title" content="Tesla Music"><meta name="theme-color" content="#111111"><link rel="apple-touch-icon" sizes="180x180" href="/icons/music-v39-180.png"><link rel="icon" type="image/png" sizes="32x32" href="/icons/music-v39-32.png"><link rel="manifest" href="/manifest.webmanifest"><link rel="stylesheet" href="/mode-v9.css?v=44"></head>`);
html=html.replace('</body>',`<script src="/app-v7.js?v=44"></script><script src="/mini-v7.js?v=44"></script><script src="/account-v8.js?v=44"></script><script src="/mode-v9.js?v=44"></script><script src="/mobile-controls-v40.js?v=44"></script><script src="/member-v41.js?v=44"></script><script src="/member-v43-fix.js?v=44"></script><script src="/member-v44-layout.js?v=44"></script><script src="https://www.youtube.com/iframe_api"></script><script>if('serviceWorker' in navigator){navigator.serviceWorker.register('/sw.js',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});}</script></body>`);
html=html.replace('./style-v7.css','/style-v7.css?v=44');
