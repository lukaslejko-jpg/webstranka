/* Music V54: /desktop-only window controls + app icon. Mobile root is untouched. */
(()=>{
'use strict';
if(!/^\/desktop\/?$/.test(location.pathname))return;
document.documentElement.dataset.musicDesktop='54';
const css=document.createElement('style');css.textContent=`html[data-music-desktop="54"] body{min-width:0}html[data-music-desktop="54"] #playerWindow{max-width:920px;margin-inline:auto}html[data-music-desktop="54"] #desktopToBar{font-size:0}html[data-music-desktop="54"] #desktopToBar:after{content:'▁';font-size:24px}html[data-music-desktop="54"] #pmin:after{content:'◱'}html[data-music-desktop="54"] #pmin{font-size:0}html[data-music-desktop="54"] #pmin:after{font-size:21px}html[data-music-desktop="54"] #pmax{font-size:0}html[data-music-desktop="54"] #pmax:after{content:'□';font-size:22px}html[data-music-desktop="54"] .desktop-music-logo{width:58px;height:58px;border-radius:14px;object-fit:cover;flex:0 0 58px}`;document.head.appendChild(css);
function brandIcon(){const top=document.querySelector('.top'),brand=document.querySelector('.brand');if(!top||!brand||document.getElementById('desktopMusicLogo'))return;const img=document.createElement('img');img.id='desktopMusicLogo';img.className='desktop-music-logo';img.src='/icons/music-v39-180.png';img.alt='Music';img.title='Music';top.insertBefore(img,brand);}
function boot(){
 brandIcon();
...
window.musicDesktopV54=Object.freeze({version:54,path:'/desktop',mobileRootUntouched:true,brandIcon:'/icons/music-v39-180.png',controls:{bar:'▁',small:'◱',max:'□'}});
