...
if MARK in js or MARK in css: raise SystemExit('V74 already applied')

anchor='function ensureMusicWindowControls(){'
if anchor not in js: raise SystemExit('ensureMusicWindowControls anchor missing')
helper=r'''
...
if bind_anchor not in js: raise SystemExit('bind anchor missing')
...
if apply_tail not in js: raise SystemExit('applyMusicWindow tail missing')
