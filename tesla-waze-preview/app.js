...
function ensureMusicWindowControls(){
  ...
  const hs=document.createElement('div');hs.id='musicHeaderSearch';hs.className='music-header-search';hs.innerHTML='<input id="musicHeaderSearchInput" type="search" autocomplete="off" placeholder="Hľadať hudbu…" aria-label="Hľadať hudbu"><button id="musicHeaderSearchBtn" type="button" class="music-header-search-btn" aria-label="Hľadať">Hľadať</button>';head.insertBefore(hs,head.querySelector('.spacer'));
